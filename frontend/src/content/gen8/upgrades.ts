...
export const UPGRADES: UpgradeDefinition[] = [
  ...
  // possuída daquele prédio (unlockAt fica em 0). ---
  {
    ...
    name: 'Pá Nova',
    kind: 'buildingBoost',
    boostsBuilding: 'digging-duo-volunteer',
    baseCost: 500,
    unlockAt: 0,
    maxPurchases: 1,
    requiresBuildingOwned: { buildingId: 'digging-duo-volunteer', count: 10 },
    effect: 0.05,
  ...
  },
  {
    ...
    unlockAt: 0,
    maxPurchases: 1,
    requiresBuildingOwned: { buildingId: 'digging-duo-volunteer', count: 25 },
    effect: 0.08,
