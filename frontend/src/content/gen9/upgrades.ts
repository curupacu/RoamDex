...
export const UPGRADES: UpgradeDefinition[] = [
  ...
  // possuída daquele prédio (unlockAt fica em 0). ---
  {
    ...
    name: 'Faca Nova',
    kind: 'buildingBoost',
    boostsBuilding: 'sandwich-volunteer',
    baseCost: 500,
    unlockAt: 0,
    maxPurchases: 1,
    requiresBuildingOwned: { buildingId: 'sandwich-volunteer', count: 10 },
    effect: 0.05,
  ...
  },
  {
    ...
    unlockAt: 0,
    maxPurchases: 1,
    requiresBuildingOwned: { buildingId: 'sandwich-volunteer', count: 25 },
    effect: 0.08,
