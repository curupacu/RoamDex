...
export const UPGRADES: UpgradeDefinition[] = [
  ...
  // possuída daquele prédio (unlockAt fica em 0). ---
  {
    ...
    name: 'Bandeja Nova',
    kind: 'buildingBoost',
    boostsBuilding: 'sushi-high-roller-volunteer',
    baseCost: 500,
    unlockAt: 0,
    maxPurchases: 1,
    requiresBuildingOwned: { buildingId: 'sushi-high-roller-volunteer', count: 10 },
    effect: 0.05,
  ...
  },
  {
    ...
    unlockAt: 0,
    maxPurchases: 1,
    requiresBuildingOwned: { buildingId: 'sushi-high-roller-volunteer', count: 25 },
    effect: 0.08,
